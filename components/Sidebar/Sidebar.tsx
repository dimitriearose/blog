...
const StyledSideBar = styled.div<Props>`
  ...
  transform: ${(props) =>
    props.isOpen ? "translateX(0px)" : "translateX(350px)"};
  display: flex;
  flex-direction: column;
  ...
  @media (max-width: 1080px) {
    width: 280px;
    transform: ${(props) =>
      props.isOpen ? "translateX(80px)" : "translateX(280px)"};
  }

  @media (max-width: 900px) {
    width: 280px;
    transform: ${(props) =>
      props.isOpen ? "translateX(155px)" : "translateX(280px)"};
  }

  @media (max-width: 720px) {
    width: 340px;
    transform: ${(props) =>
      props.isOpen ? "translateX(155px)" : "translateX(340px)"};
  }

  @media (max-width: 500px) {
    width: 280px;
    transform: ${(props) =>
      props.isOpen ? "translateX(150px)" : "translateX(280px)"};
  }
`
